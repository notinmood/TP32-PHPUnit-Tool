...
class View {
    ...
    private function render($content,$charset='',$contentType=''){
        ...
        // 网页字符编码
        headers_sent() or header('Content-Type:'.$contentType.'; charset='.$charset);
        headers_sent() or header('Cache-control: '.C('HTTP_CACHE_CONTROL'));  // 页面缓存控制
        headers_sent() or header('X-Powered-By:ThinkPHP');
        // 输出模板文件
        echo $content;
    }
